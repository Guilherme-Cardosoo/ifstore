  ...
  <main class="product-details-container">
    ...
    <div v-if="product" class="product-details">
      ...
      <div class="product-info">
        ...
        <button class="add-to-cart" @click="CartStore.addproduct(product)">Adicionar ao Carrinho</button>
...
const product = products.products.find(p => p.id === Number(route.params.id))
